...
serverOpt, localOpt, tagOpt, apiKeyOpt, proxyOpt, sslKeystoreOpt, sslFingerprintOpt, fusionCompatOpt,
            tasksOpt, noTaskOpt,
            delayOpt, lazyOpt, onceOpt, fullInventoryPostponeOpt, requiredCategoryOpt, additionalContentOpt, noCategoryOpt, itemtypeOpt, esxItemtypeOpt, scanHomeDirsOpt,
        ...
        rootCommand.SetAction(async (pr, ct) =>
        {
            ...
            var options = BuildOptions(pr, serverOpt, localOpt, tagOpt, apiKeyOpt, proxyOpt, sslKeystoreOpt, sslFingerprintOpt, fusionCompatOpt, tasksOpt, noTaskOpt,
                delayOpt, lazyOpt, onceOpt, fullInventoryPostponeOpt, requiredCategoryOpt, additionalContentOpt, noCategoryOpt, itemtypeOpt, esxItemtypeOpt, scanHomeDirsOpt, httpPortOpt, httpTrustOpt, noHttpdOpt,
    ...
    static AgentOptions BuildOptions(ParseResult pr,
        ...
        Option<int> delayOpt, Option<bool> lazyOpt, Option<bool> onceOpt, Option<int> fullInventoryPostponeOpt, Option<string?> requiredCategoryOpt, Option<string?> additionalContentOpt, Option<string?> noCategoryOpt, Option<string?> itemtypeOpt, Option<string?> esxItemtypeOpt, Option<bool> scanHomeDirsOpt,
